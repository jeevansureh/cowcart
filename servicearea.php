...
<a class="fa fa-plus-circle" href="addservicearea.php">Add</a>
</button>
  ...
  <tbody>
    ...
    $result=mysqli_query($conn,$sql);
                    ...
                    <td>
                                        <form method="POST" action="deleteservicearea.php">
                                        <input type="hidden" name="ids" value="<?php echo $row['service_id'];?>">
