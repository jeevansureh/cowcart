...
<head>
    <meta charset="utf-8">
    <title>COWCART- Dairy Website Template</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
        <a href="index.html" class="navbar-brand d-flex align-items-center">
            <h1 class="m-0">COWCART</h1>
                ...
                <a href="#about-start" class="nav-item nav-link">About</a>
                <a href="service.html" class="nav-item nav-link">Services</a>
                <a href="#product-start" class="nav-item nav-link">Products</a>
    ...
    <ul class="navbar-nav ms-auto p-4 p-lg-0">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown_2">
                <a class="dropdown-item" href="customer_login.php">as Customer</a>
                <a class="dropdown-item" href="staff_login.php">as Staff</a>
            </div>
        </li>
        <li class="nav-item">
        ...
        <div class="container">
            <div class="row g-5 align-items-end">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p class="mb-4">NO.1 Dairy Farm in the History</p>
                    <div class="row g-5 pt-2 mb-5">
                        <div class="col-sm-6">
                            <img class="img-fluid mb-4" src="img/service.png" alt="">
                            <h5 class="mb-3">Dedicated Services</h5>
                            <span>24*7 customer Support and superfast delivory survice</span>
                        </div>
                        <div class="col-sm-6">
                            <img class="img-fluid mb-4" src="img/product.png" alt="">
                            <h5 class="mb-3">Organic Products</h5>
                            <span>100% organic Products that are rich in protein content</span>
                        </div>
                    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-sm-8">
                            ...
                            <p class="text-white mb-4">"Experience the pure essence of nature in every sip and bite,our dairy farm's finest products,crafted with love and tradition."</p>
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-sm-8">
                            <h2 class="text-white mb-3">We Deliver Fresh products</h2>
                            <p class="text-white mb-4">"From our farm to your table,savour the freshness and goodness of our dairy products delivered with care."</p>
                            <a class="btn btn-secondary rounded-pill py-2 px-4" href="">Read More</a>
                        </div>
                    </div>
                </div>
    ...
    <!-- Product Start -->
    <section id="product-start"></section>
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row gx-4">
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="product-item">
                        ...
                        <div class="text-center p-4">
                            ...
                            <span class="text-primary me-1">₹59</span>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="product-item">
                        ...
                        <div class="text-center p-4">
                            ...
                            <span class="text-primary me-1">₹399</span>
                            <span class="text-decoration-line-through">₹599</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="product-item">
                        ...
                        <div class="text-center p-4">
                            ...
                            <span class="text-primary me-1">₹99</span>
                            <span class="text-decoration-line-through">₹199</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="product-item">
                        ...
                        <div class="text-center p-4">
                            <a class="d-block h5" href="">Pure Ghee</a>
                            <span class="text-primary me-1">₹499</span>
                            <span class="text-decoration-line-through">₹599</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="fw-semi-bold" href="#">COWCART</a>, All Right Reserved.
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                    Designed By <a class="fw-semi-bold" href="#">jeevan</a>
                </div>
            </div>
        </div>
    </div>
